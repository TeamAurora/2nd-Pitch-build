...
void GameState::CreateObjects()
{
	...
	//slope
	spike_[1].CreateStaticBody(world_,GFX_BOX2D_POS_X(platform_.width()*0.66f),GFX_BOX2D_POS_Y(platform_.height()*0.795),
		GFX_BOX2D_SIZE(platform_.width()*0.16),GFX_BOX2D_SIZE(10));
